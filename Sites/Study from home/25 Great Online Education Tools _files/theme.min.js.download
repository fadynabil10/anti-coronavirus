            ...
            return _createClass(e, [{
                ...
                value: function(e) {
                    ...
                    return n.forEach(function(e) {
                      ...
                      if (t.itemCount == 0) {
                        $('.wc-cart').find('.Header__CartCount').removeClass('wc-count');
                        $('.wc-cart').find('.Header__CartCount').addClass('hide');
                        $('.Header__FlexItem--fill').find('.wc-cart').removeClass('wc-cart-sticky');
                        // console.log('if')
                      } else {
                        $('.wc-cart').find('.Header__CartCount').addClass('wc-count');
                        $('.wc-cart').find('.Header__CartCount').removeClass('hide');
                        $('.Header__FlexItem--fill').find('.wc-cart').addClass('wc-cart-sticky');
                        // console.log('else')
                      }
    ...
    var i = n(0),
        ...
        o = function() {
            ...
            return _createClass(e, [{
                ...
                value: function(e) {
                    var t = this,
                        n = e.target.closest(".HorizontalList__Item, .wc-link");
                    fastdom.mutate(function() {
                ...
                key: "onBlockDeselect",
                value: function(e) {
                    var t = e.target.closest(".HorizontalList__Item, .wc-link");
                    fastdom.mutate(function() {
